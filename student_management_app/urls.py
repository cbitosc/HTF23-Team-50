...
from .views import CertificateIssuanceView
...
urlpatterns = [
    ...
    path('certificate_issuance_view/', CertificateIssuanceView.as_view(), name="certificate_issuance_view"),
    path('approve_certificate/<certificate_id>/', CertificateIssuanceView.approve_certificate, name="approve_certificate"),
    path('reject_certificate/<certificate_id>/', CertificateIssuanceView.reject_certificate, name="reject_certificate"),
