...
class FeedBackStudent(models.Model):
    ...
    feedback_reply = models.FileField()
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    objects = models.Manager()
...
class CertificateIssuance(models.Model):
    # Define fields for the CertificateIssuance model
    # For example:
    student = models.ForeignKey('Students', on_delete=models.CASCADE)
    certificate_status = models.CharField(max_length=255)

    # Add any other fields you need for the CertificateIssuance model

    def __str__(self):
        return f"Certificate for {self.student.admin.first_name} {self.student.admin.last_name}"
